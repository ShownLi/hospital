	...
	<section>
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<i class="fa fa-user"></i> 患者管理 <span>新增患者</span>
				</h2>
			</div>
        ...
        <div class="panel-heading">
          ...
          <h4 class="panel-title">患者基本信息</h4>
          <p>填写下表，完成患者创建。</p>
        </div>
        ...
        <div class="panel-body panel-body-nopadding">
          	...
          	<div class="section-block">
	            <div class="form-group col-sm-4">
	              ...
	              <div class="col-sm-8">
	                <input type="text" id="name" name="name" placeholder="患者姓名" class="form-control" />
	              </div>
	            </div>
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">年龄<span class="asterisk">*</span></label>
	              <div class="col-sm-8">
	                <input type="text" name="birthday" placeholder="年龄" class="form-control" />
	              </div>
	            </div>  
	            <div class="form-group col-sm-4">
	        ...
	        <div class="section-block">
	             <div class="form-group col-sm-4">
          			<label class="col-sm-4 control-label">紧急联系人电话</label>
           			<div class="col-sm-8">
           				<input type="text" id="urgentPhone" name="urgentPhone" class="form-control"/>
           			</div>
           		</div>
	            <div class="form-group col-sm-4">
        ...
        <div class="panel-footer align-center">
			<input id="addDoctor" onclick="form_submit()" class="btn btn-primary" type="submit" value="保存"/>&nbsp;
  ...
  <div class="modal-dialog">
	...
	<script type="text/javascript">
		...
		function form_submit() {
			...
			$.post('${rootPath}patient/add.do', f, function(result) {
				var rmsg = result.msg;
				if (result.success) {
