              ...
              <div class="section-block noline">
                  <div class="form-group col-sm-6">
                      ...
                      <div class="col-sm-8 input-group input-datepicker">
                        <input type="text" name="groupTime" placeholder="成团日期" class="form-control datepicker" autocomplete="off">
                  ...
                  <div class="form-group col-sm-6">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="currency" placeholder="货币种类" class="currency-select fullwidth" value=""/>
                      </div>
                  </div>
                  <div class="form-group col-sm-6">
