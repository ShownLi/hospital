	...
	<section>
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<i class="fa fa-user"></i> 订单管理 <span>新增订单</span>
				</h2>
        ...
        <div class="panel-body panel-body-nopadding">
	          <div class="section-block">
	            <div class="form-group col-sm-4">
	              ...
	              <div class="col-sm-8">
	                <input type="text" name="customer_name" placeholder="客人姓名" class="form-control"  value="" />
	              </div>
	            </div>
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">地接社名称</label>
	              <div class="col-sm-8">
	                <input type="text" name="agency_name" placeholder="地接社名称" class="form-control" value="" />
	              </div>
	            </div>              
	            <div class="form-group col-sm-4">
	            ...
	            <div class="form-group col-sm-4">
	              ...
	              <div class="col-sm-8">
	                <input type="text" name="destination" placeholder="目的地" class="form-control" value="" />
	              </div>
	            </div>
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">预算</label>
	              <div class="col-sm-8">
	                <input type="text" name="budget" placeholder="预算" class="form-control" value="" />
	              </div>
	            </div>
	            <div class="form-group col-sm-4">
	        ...
	        <div class="section-block">
	            <div class="form-group col-sm-4">
	              ...
	              <div class="col-sm-8">
	                <input type="text" name="last_response" placeholder="最后回复时间" class="form-control" value="" />
	              </div>
	            </div>
