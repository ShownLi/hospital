	...
	<section>
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<i class="fa fa-user"></i> 医生管理 <span>新增医生</span>
				</h2>
			</div>
        ...
        <div class="panel-heading">
          ...
          <h4 class="panel-title">医生基本信息</h4>
          <p>填写下表，完成医生创建。</p>
        </div>
        ...
        <div class="panel-body panel-body-nopadding">
          	...
          	<div class="section-block">
	            <div class="form-group col-sm-4">
	              ...
	              <div class="col-sm-8">
	                <input type="text" id="name" name="name" placeholder="医生姓名" class="form-control" />
	              </div>
	            </div>
	            <div class="form-group col-sm-4">
	        ...
	        <div class="section-block">
	             <div class="form-group col-sm-4">
          			<label class="col-sm-4 control-label">医生级别</label>
           			<div class="col-sm-8">
           				<input type="text" id="level" name="level" class="level-select fullwidth"/>
           			</div>
           		</div>
	            <div class="form-group col-sm-4">
	              <label class="col-sm-4 control-label">所属科室</label>
	              <div class="col-sm-8">
	                <input type="text" id="dept" name="dept" class="dept-select fullwidth" />
	              </div>
	            </div>            
	            <div class="form-group col-sm-4">
  ...
  <div class="modal-dialog">
	...
	<script type="text/javascript">
		...
		function form_submit() {
			...
			$.post('${rootPath}doctor/add.do', f, function(result) {
